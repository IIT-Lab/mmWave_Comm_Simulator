%h5gPDSCHTBS 5G PDSCH transport block size determination
%   TBS = h5gPDSCHTBS(CHS,NRED) returns the transport block size associated
...
%   overhead (Xoh-PDSCH).
% 
%   See also h5gDLSCH, h5gDLSCHDecode, h5gPDSCHResources.

%   Copyright 2018 The MathWorks, Inc.

function tbs = h5gPDSCHTBS(pdsch,nred)
